...
function go_setup() {
	 ...
	 * If you're building a theme based on go, use a find and replace
...
function go_scripts() {
	...
	wp_enqueue_script( 'go-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'go-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
...
require 'functions/description-walker.php';
